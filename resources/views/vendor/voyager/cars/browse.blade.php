...
<div class="container-fluid">
    ...
    <button class="btn btn-success btn-add-new" style="background:#22a7f0;" data-toggle="modal"
        data-target="#csvModal"><i class="voyager-medal-rank-star"></i> Import CSV</button>

    <a href="export" class="btn btn-success btn-add-new" style="background:#22a7f0;">
        <i class="voyager-medal-rank-star"></i>
        Export CSV
    </a>
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('import_parse') }}"
                        ...
                        <div class="form-group{{ $errors->has('csv_file') ? ' has-error' : '' }}">
                            <label for="csv_file" class="col-md-12 control-label">CSV file to
                                import</label>

                            <div class="col-md-12">
                                <input id="csv_file" type="file" class="form-control" style="height:inherit"
